...
仓库总入口就是根目录 `README.md`。

- 第一次进入仓库：先读本文，再继续看 [00-docs/00-导航/01-新手启动路径.md](./00-docs/00-导航/01-新手启动路径.md)
- [00-docs/README.md](./00-docs/README.md) 只负责 `00-docs/` 内部索引，不替代仓库总入口
