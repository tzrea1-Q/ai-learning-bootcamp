...
- 沉淀博客选题与技术博文
- 开发并交付 AI 项目
- 撰写方案文档、README、复盘和案例文档

## 适合谁

这套仓库适合以下人群：

- 刚开始做 AI 开发，不知道如何系统入门的人
- 会一点 Python / Web 基础，但缺少工程化训练的人
- 能用 AI 工具，但不会把 AI 用进开发闭环的人
- 想把学习过程沉淀成公开作品集的人

不适合完全零编程基础、只想看概念介绍而不做项目的人。

## 你会得到什么

完成这套训练后，你应该至少留下 6 类资产：

1. 可运行的 AI 项目
2. 日报与周报记录
3. 博客草稿与技术文章
4. 方案文档与架构说明
5. README / Case Study / Postmortem
6. 可展示的作品集素材
...
├─ 00-docs/               # 方法论、导航、训练主线、执行系统、输出系统、项目系统
├─ 01-templates/          # 日报/周报/博客/README/方案/复盘/案例模板
...
- AI 是协作工具，不是替代判断
- 所有学习都要沉淀成代码、文档和证据
- 所有测试、联调、回归和样例验证都必须留 `md` 记录，没留痕视为未完成验证

详细文档索引见 [00-docs/README.md](./00-docs/README.md)。
执行规则见 [00-docs/02-执行系统/09-测试与样例留痕规则.md](./00-docs/02-执行系统/09-测试与样例留痕规则.md)。
