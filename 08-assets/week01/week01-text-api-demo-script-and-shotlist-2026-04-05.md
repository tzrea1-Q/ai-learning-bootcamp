# week01-text-api Demo 录制脚本与截图清单｜2026-04-05
...
- 画面：
  - 打开仓库根目录，聚焦 `04-projects/week01-text-api/README.md`
  - 顺手展示 `docs/traces/`、`07-postmortems/`、`.github/workflows/`
- 讲解词：
  - “这是我第 1 周完成的 `week01-text-api`。这周目标不是做很多功能，而是把一个最小文本 API 从本地跑通，推进到有测试、有文档、有 traces、也有 postmortem 的最小工程闭环。”
...
- 画面：
  ...
  - 展示 `.github/workflows/week01-text-api-pytest.yml`
- 讲解词：
...
- 画面内容：
  - `04-projects/week01-text-api/README.md`
...
- 二选一即可：
  - 终端中的 `12 passed` 测试结果
  - `.github/workflows/week01-text-api-pytest.yml` 文件
- 用途：
